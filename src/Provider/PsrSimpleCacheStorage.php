...
/**
 * Class PsrSimpleCacheStorage (PSR-16 Cache)
 *
 * @package Naucon\Storage\Provider
 * @author Sven Sanzenbacher
 */
class PsrSimpleCacheStorage extends AbstractStorage implements IdentityFlattenerAwareInterface, IdentityValidatorAwareInterface, NamespaceGeneratorAwareInterface
{
     ...
     * @param int $lifetime
     */
    public function __construct(CacheInterface $cache, $modelClass = null, $namespace = null, $lifetime = 0)
    {
    ...
    {
        throw new UnsupportedException('findAll is not supported in a PSR-16 simple cache.');
    }
